...
class camera {
  ...
  private:
    ...
    Vector3d u, v, w;      // Base ortonormal da câmera
    ...
    void initialize() {
        ...
        // Base ortonormal a partir de lookfrom/lookat/vup
        w = (lookfrom - lookat).normalizacao();
        u = vup.produto_vetorial(w).normalizacao();
        ...
        auto viewport_upper_left =
            center - (w * screen_distance) - viewport_u/2 - viewport_v/2;
